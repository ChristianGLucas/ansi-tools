// Shared test context for ansi-tools node unit tests. Not a node and not a
...
// Convenience: ESC as a value (never a literal control char in source).
export const ESC = '\x1b';
export const sgr = (params: string) => `${ESC}[${params}m`;
